...
/*   Updated: 2022/12/09 18:38:38 by lfranca-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cast_rays(t_map *map)
{
	...
	{
		// -------------- linhas horizontais
		check_horizontal_hit(map, &horiz_position[0], &horiz_position[1]);
		// -------------- linhas verticais
		check_vertical_hit(map, &vert_position[0], &vert_position[1]);
